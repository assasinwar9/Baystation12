...
/datum/antagonist/changeling
	blacklisted_jobs = list(/datum/job/merchant, /datum/job/captain, /datum/job/hop, /datum/job/submap)

/datum/antagonist/godcultist
	blacklisted_jobs = list(/datum/job/chaplain, /datum/job/merchant, /datum/job/captain, /datum/job/hop, /datum/job/hos, /datum/job/submap)

/datum/antagonist/cultist
	blacklisted_jobs = list(/datum/job/chaplain, /datum/job/psychiatrist, /datum/job/merchant, /datum/job/captain, /datum/job/hop, /datum/job/hos, /datum/job/submap)

/datum/antagonist/loyalists
	blacklisted_jobs = list(/datum/job/merchant, /datum/job/submap)
