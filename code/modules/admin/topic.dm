/datum/admins/Topic(href, href_list)
	...
	if(href_list["dbsearchckey"] || href_list["dbsearchadmin"])
		...
		switch(href_list["simplemake"])
			...
			if("mnabber1")				M.change_mob_type( /mob/living/carbon/human/mantid/monarch_worker , null, null, delmob )
			if("cat")				M.change_mob_type( /mob/living/simple_animal/cat , null, null, delmob )
			if("mnabber2")				M.change_mob_type( /mob/living/carbon/human/mantid/monarch_queen , null, null, delmob )
			if("corgi")				M.change_mob_type( /mob/living/simple_animal/corgi , null, null, delmob )
			if("malate")				M.change_mob_type( /mob/living/carbon/human/mantid/alate , null, null, delmob )
			if("crab")				M.change_mob_type( /mob/living/simple_animal/crab , null, null, delmob )
			if("mgyne")			M.change_mob_type( /mob/living/carbon/human/mantid/gyne , null, null, delmob )
